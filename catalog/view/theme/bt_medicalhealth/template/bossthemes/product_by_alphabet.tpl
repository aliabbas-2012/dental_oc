...
<div id="content" class="search_form"><?php echo $content_top; ?>
  ...
  <div class="product-list">
    ...
    <div class="<?php echo (($key+1)%4==0 ? 'one-product-list last' : 'one-product-list' ); echo ($product==end($products) ? ' lastest' : ''); ?>">
      ...
      <div class="rating"><img src="catalog/view/theme/medicalhealth/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" /></div>
      <?php } ?>
