...
<?php } ?>
<div id="content" class="sixteen alpha columns clearfix">
<?php echo $content_top; ?>
  ...
  <div class="login-content">
    <div class="left">
      ...
      <div class="content"><?php echo $text_register_account; ?> <a href="<?php echo $register; ?>" class="orange_button"><span><?php echo $button_continue; ?></span></a></div>
    </div>
    <div class="right">
