  ...
  <table class="compare-info">
	...
	<tbody>
      <tr>
        ...
        <div class="image"><img src="<?php echo $products[$product['product_id']]['thumb']; ?>" alt="<?php echo $products[$product['product_id']]['name']; ?>" title="<?php echo $products[$product['product_id']]['name']; ?>" /></div>
		<div class="name"><a href="<?php echo $products[$product['product_id']]['href']; ?>"><?php echo $products[$product['product_id']]['name']; ?></a></div></td>
        <?php } ?>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td class="availability"><?php echo $products[$product['product_id']]['availability']; ?></td>
        <?php } ?>
      </tr>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td><img src="catalog/view/theme/bt_medicalhealth/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
    ...
    <tr>
      <td></td>
      <?php foreach ($products as $product) { ?>
      <td><div class="cart"><input type="button" value="<?php echo $button_cart; ?>" onclick="boss_addToCart('<?php echo $product['product_id']; ?>');" class="button" /></div></td>
      <?php } ?>
    </tr>
  </table>
  </div>
  <div class="buttons button_compare">
