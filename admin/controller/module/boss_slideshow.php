...
class ControllerModuleBossSlideshow extends Controller {
	...
	public function index() {   
		$this->language->load('module/boss_slideshow');
	...
	public function install() 
	{
		...
		$boss_slideshow = array('image_sliders' => array ( 
			0 => array ('description' => $array_description0,'link' => '#', 'image' => 'data/medicalhealth/banner01.jpg'),
			1 => array ('description' => $array_description1,'link' => '#', 'image' => 'data/medicalhealth/banner02.jpg'),
			2 => array ('description' => $array_description2,'link' => '#', 'image' => 'data/medicalhealth/banner03.jpg'),
		),'boss_slideshow_module' => array ( 
			0 => array ('image_width' => 1920, 'image_height' => 500, 'layout_id' => $this->getIdLayout("home"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 1))
		);
