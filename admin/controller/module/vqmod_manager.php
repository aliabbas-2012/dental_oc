...
class ControllerModuleVQModManager extends Controller {
	...
	private function vqmod_installation_check() {
		...
		// Check that your Onlinestore 1.5.x is being used - other errors will appear on the page if they're using 1.4.x but at least the user will be told what the issue is
		...
		// If your Onlinestore 1.5.4+ check that vqmod_opencart.xml 2.1.7 or later is being used
		...
		// Check if VQMod class is added to your Onlinestore
