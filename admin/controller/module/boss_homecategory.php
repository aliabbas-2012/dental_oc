...
class ControllerModuleBossHomecategory extends Controller {
	...
	public function index() {   
		...
		//list category
		$boss_homecategory_check = array();
		if (isset($this->request->post['boss_homecategory_check'])) {
			$boss_homecategory_check = $this->request->post['boss_homecategory_check'];
		} elseif ($this->config->get('boss_homecategory_check')) { 
			$boss_homecategory_check = $this->config->get('boss_homecategory_check');
		}
		...
		foreach ($results as $result) {
			$select = 0;
			if(in_array($result['category_id'], $boss_homecategory_check )){
				$select = 1;
			}
			$this->data['categories'][] = array(
	...
	public function install() 
	{
		...
		$boss_homecategory = array('boss_homecategory_module' => array ( 
			0 => array ('width' => 128, 'height' => 128, 'limit' => 2, 'layout_id' => $this->getIdLayout("home"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 6))
		);
