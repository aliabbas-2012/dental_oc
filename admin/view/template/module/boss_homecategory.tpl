...
<div class="box">
  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <!-- start category -->
	  <h3></h3>
	  <div style="height: 280px; overflow-y: scroll; margin: 20px;">
		<table class="list">
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($category['selected']) { ?>
                <input type="checkbox" name="boss_homecategory_check[<?php echo $category['category_id']; ?>]" value="<?php echo $category['category_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="boss_homecategory_check[<?php echo $category['category_id']; ?>]" value="<?php echo $category['category_id']; ?>" />
                <?php } ?></td>
