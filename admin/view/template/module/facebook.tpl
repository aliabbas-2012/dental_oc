    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><textarea name="facebook_code" cols="40" rows="5"><?php echo $facebook_code; ?></textarea>
            <?php if ($error_code) { ?>
      ...
      <table id="module" class="list">
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            ...
            <td class="right"><input type="text" name="facebook_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
...
function addModule() {	
    ...
    html += '    </select></td>';
	html += '    <td class="right"><input type="text" name="facebook_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
