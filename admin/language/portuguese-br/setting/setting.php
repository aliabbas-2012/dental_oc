...
$_['entry_return']                 = 'Termo de Devolução:<br /><span class="help">Forças que aceitem os termos antes que uma solicitação de retorno possa ser enviada.</span>';
...
$_['entry_ftp_root']               = 'Diretório FTP:<span class="help">Caminho onde o seu loja virtual está instalado (normalmenet \'public_html/\').</span>';
...
$_['entry_secure']                 = 'Usar SSL:<br /><span class="help">Antes de ativar esta opção, verifique com sua empresa de hospedagem se o mesmo está instalado e se você já  incluiu a URL SSL nos arquivos config.php que ficam na raiz da loja e no diretório de administração.</span>';
$_['entry_shared']                 = 'Usar Sessões Compartilhadas:<br /><span class="help">Tentar compartilhar o cookie de sessão entre as múltiplas lojas configuradas, a fim de que o carrinho possa ser transferido entre os diferentes domínios.</span>';
$_['entry_robots']                 = 'Robots:<br /><span class="help">Lista de "user agents" de robôs de busca para os quais as sessões compartilhadas não serão utilizadas. Digite um por linha.</span>';
...
$_['entry_file_extension_allowed'] = 'Extensões de arquivo permitidas:<br /><span class="help">Digite as extensões de arquivos permitidas para upload. Digite um por linha..</span>';
$_['entry_file_mime_allowed']      = 'Mime Types de arquivo permitidos:<br /><span class="help">Digite os mime types permitidos para os uploads de arquivos (ex: image/jpeg, application/pdf, etc). Digite um por linha.</span>';
...
$_['entry_password']               = 'Permitir recuperação de senha:<br /><span class="help">Permitir o uso do formulário de recuperação de senha no painel de administração. Este recurso será desabilitado automaticamente se o sistema detectar uma tentativa de invasão.</span>';
...
$_['error_ftp_host']               = 'Host FTP requerido!';
$_['error_ftp_port']               = 'Porta FTP requerida!';
$_['error_ftp_username']           = 'Usuário FTP requerido!';
