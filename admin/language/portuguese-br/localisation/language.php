...
// Entry
$_['entry_name']        = 'Idioma:<br /><span class="help">Ex.: Português (BR)<br />Identificação do idioma.</span>';
$_['entry_code']        = 'Código:<br /><span class="help">Ex.: pt-br<br />Não altere se este for o idioma padrão da loja.</span>';
$_['entry_locale']      = 'Localização:<br /><span class="help">Ex.: pt_BR.UTF-8,pt_BR,UTF-8,portuguese,portugues</span>';
